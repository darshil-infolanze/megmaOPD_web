    ...
    <div className="min-h-screen bg-white py-10 px-4 flex justify-center">
      <div className="w-full max-w-4xl">
        ...
        <div className="border border-[#8b5cf6] p-8 rounded-md space-y-4 text-slate-700">
          ...
          <p className="mt-4">
            Please read the Terms carefully prior to using, signing up or
            registering on our Online Platform or accessing/availing our
            Services. By signing up to use the Online Platform, you acknowledge
            that you have read these Terms and agree to be bound by them. You
            also acknowledge that you have read our Privacy Policy and agree to
            be bound by it. By signing up to use the Online Platform, you
            represent that you have provided us with valid identifying
            information which may be used to verify your identity. Please note
            that we may restrict, suspend, or terminate your access at any time
            to the Online Platform if we believe you have breached these Terms.
            We may use certain technologies to monitor your activities on the
            Online Platform in accordance with our Privacy Policy.
          </p>
          <p className="mt-4">
            We may modify these Terms or any other terms at any time by posting
            a revised version of the same on the Online Platform, and the
            amended version of these Terms shall become automatically binding
            upon you if you continue to avail the Services. The amended Terms
            will be applicable even if not accepted by you separately. You shall
            have the responsibility to review these Terms on a regular basis. If
          ...
          <p className="mt-2">
            <strong>“Applicable Law”</strong> includes all applicable Indian
            statutes, enactments, acts of the state legislature or parliament,
            laws, ordinances, rules, bye-laws, regulations, notifications,
            guidelines, directions, directives and orders of any governmental
            authority, statutory authority, board, recognized stock exchange, as
            may be applicable.
          </p>
          <p className="mt-2">
            ...
            current or historical data, computer programs or documentation and
            all other technical, financial or business data, internal
            ...
            contract terms and conditions, and other valuable confidential
          ...
          <p className="mt-4">
            ...
            property used for the purpose of or in association with or in
            relation to the performance of these Terms, and includes without
          ...
          <p className="mt-2">
            You agree to use the Website and Service solely for lawful purposes
            and in accordance with these Terms. You are prohibited from using
            the Website or Service in any way that:
            <br />• Could damage, disable, overburden, or impair the Website or
            Service.
            <br />• Interferes with any other user’s enjoyment of the Website or
            Service.
            <br />• Attempts to gain unauthorized access to the Website or
            Service, or any connected computer systems or networks.
            <br />• Uploads, transmits, or stores content that is unlawful,
          ...
          <ol className="list-[lower-roman] list-inside text-slate-700 mt-2 space-y-1">
            ...
            <li>you are of the legal age to access the Online Platform;</li>
            <li>
              you are solely responsible for the user content and all activities
              that occur on or through your device;
            </li>
            <li>
            ...
            <li>
              ...
              software viruses, trojan horses, worms, time-bombs, keystroke
              loggers, spyware, adware or any other computer code, files or
              programs designed to interrupt, destroy or limit the functionality
              of any computer software or hardware or telecommunications
              equipment;
            </li>
            <li>
              undertaking any action that imposes or may impose, in our sole
              discretion, an unreasonable or disproportionately large load on
              our infrastructure;
            </li>
            <li>
              use of data mining, robots, spiders, scrapers, crawlers, avatars
              or similar data gathering and extraction tools;
            </li>
            <li>
              making any back-up or archival copies of the Online Platform or
              any part thereof;
            </li>
            <li>
              bypassing any measures used by us to prevent or restrict access to
              the Online Platform;
            </li>
            <li>using the Online Platform for any commercial purpose;</li>
            <li>
              violating the restrictions in any robot exclusion headers on the
              Online Platform or bypassing or circumventing other measures
              employed to prevent or limit access to the Online Platform;
            </li>
            <li>
              deep-linking to any portion of the Online Platform (including,
              without limitation, the purchase path for any service) for any
              purpose without our express written permission;
            </li>
            <li>
              ‘framing’, ‘mirroring’ or otherwise incorporating any part of the
              Online Platform into any other website without our prior written
              authorization;
            </li>
            <li>
              use the Online Platform in (i) any unlawful manner, (ii) for
              fraudulent or malicious activities, or (iii) in any manner
              inconsistent with these Terms or violate Applicable Laws in any
              manner.
            </li>
          </ol>
          <h3 className="text-lg font-semibold text-[#64748B] mt-6">
          ...
          <p className="mt-2">
            You agree and understand that all of the content accessed by you on
            the Online Platform is purely for informational purposes aimed to
          ...
          <ul className="list-disc list-inside text-slate-700 mt-2 space-y-1">
            ...
            <li>
              “Test/s” includes consultations, appointments, tests, procedures,
              surgeries, medications, or anything else related, even if not
          ...
          <ul className="list-disc list-inside text-slate-700 mt-2 space-y-1">
            ...
            <li>
              By using the site and sharing your details, you agree to avail of
          ...
          <p className="mt-2">
            Although we may post information, material and content on the Online
            Platform based on reliable sources, we do not make any express or
            implied representation, warranty or guarantee as to the accuracy,
            validity, reliability or completeness of any such information. The
            features and services of the Online Platform are provided on an “as
            is” and “as available” basis. We make no representation or warranty
          ...
          <ol className="list-[lower-roman] list-inside text-slate-700 mt-2 space-y-1">
            ...
            <li>
              ...
              by any unauthorized person, and
            </li>
            <li>
              you shall not misuse the Intellectual Property or use it together
          ...
          <p>
            ...
            such security, confidentiality and degree of utmost care as it would
            prudently apply to its own confidential information and use it
            ...
            aware of the sensitivity and secrecy involved in keeping such
          ...
          <ol className="list-[lower-roman] list-inside text-slate-700 mt-2 space-y-1">
            ...
            <li>
              ...
              otherwise than by reason of a breach by the receiving Party of
              these Terms;
            </li>
            <li>
              Information that becomes legally available to the receiving Party
              and/or its affiliates or professional advisors on a
              non-confidential basis from any third party, the disclosure of
              which does not, to the knowledge of that Party, violate any
              contractual or legal obligation which such third party has to the
              other Party with respect to such information;
            </li>
            <li>
              Information that is independently acquired or developed by the
              receiving Party.
            </li>
          </ol>
          <p className="mt-4">
          ...
          <ol className="list-[lower-roman] list-inside text-slate-700 mt-2 space-y-1">
            <li>
              ...
              and any employees thereof that it reasonably determines need to
            ...
            <li>
              Disclosures to any person to whom it is required by any Applicable
              Law or any applicable regulatory, supervisory, judicial or
              governmental order, to disclose such information, or at the
              request of any regulatory or supervisory or judicial or government
              authority.
            </li>
          </ol>
          <h3 className="text-lg text-[#64748B] font-semibold mt-6">
          ...
          <p>
            ...
            to the use of, or the inability to use, the Services and functions
          ...
          <p>
            ...
            violation of these Terms or other applicable policies we may publish
            from time to time. Any termination of the Services may also be
          ...
          <p>
            ...
            understanding the Terms and Privacy Policy and assumes all risk that
          ...
          <p>
            ...
            usage of the Online Platform, utility or communication failures,
            earthquakes, pandemic, lockdown, war, revolution, acts of terrorism,
          ...
          <p>
            ...
            provisions shall remain in full force and effect. In the event any
            provision of these Terms is determined to be invalid or
            unenforceable, such provision shall be deemed severed from the
            remainder of these Terms and replaced with a valid and enforceable
            provision as similar in intent as reasonably possible to the
          ...
          <p>
            ...
            be transferred or assigned by you. We may assign, in whole or in
            part, the benefits or obligations hereunder. We may, at our
            discretion, provide an intimation of such assignment to you, which
            will be binding on the Parties to these Terms. Unless otherwise
            expressly stated, the failure to exercise or delay in exercising a
            right or remedy under these Terms will not constitute a waiver of
            the right or remedy or a waiver of any other rights or remedies, and
