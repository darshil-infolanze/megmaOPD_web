    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-violet-500 to-slate-600 flex items-center justify-center p-4 font-inter">
      <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 max-w-4xl w-full mx-auto my-8">
        ...
        <div className="text-slate-700 text-sm mb-4">
          <p>
            Magma OPD shall not be held responsible for any payments made
            outside of our official website or authorized payment gateways.
            Customers are advised to ensure that all payments for health plans
            or services are made directly through our secure platform. The
            company will not be liable for any loss or dispute arising from
            transactions made through third parties or unauthorized agents.
          </p>
        </div>
