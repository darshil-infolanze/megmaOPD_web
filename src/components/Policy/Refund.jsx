    ...
    <div className="min-h-screen bg-white py-10 px-4 flex justify-center">
      <div className="w-full max-w-4xl">
        ...
        <div className="border border-[#1EA1A9] p-8 rounded-md space-y-4 text-gray-700">
          <p>
            At AxenCare, we are committed to delivering quality Healthcare and
          ...
          <ul className="list-disc list-inside mb-6 space-y-1">
            <li>
              ...
              delivered by AxenCare within the stipulated time, you are eligible
              for a refund.
            </li>
            <li>
          ...
          <p>
            ...
            <strong>support@axencare.in</strong> with the following:
          </p>
          <ul className="list-disc list-inside space-y-1">
            <li>
          ...
          <p>AxenCare reserves the right to amend this policy at any time. Updated versions will be posted on our website with the “Last Updated” date. Your continued use of our services constitutes acceptance of the revised terms.</p>
        </div>
      </div>
    </div>
  );
