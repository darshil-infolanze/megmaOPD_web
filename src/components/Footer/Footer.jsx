      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="mt-8 text-gray-600 text-sm">
            ...
            <div className="flex items-center mb-2">
             <IoMail className='text-[#8CC63E]' />
              <a href="mailto:hello@axencare.in" className="hover:underline text-[#1EA1A9]"> &nbsp;&nbsp;hello@axencare.in</a>
            </div>
            <div className="flex items-center">
             <FaPhone  className='text-[#8CC63E]'/>
              <a href="tel:011-43658206" className="hover:underline text-[#1EA1A9]">&nbsp;&nbsp;011-43658206</a>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="/about" className="text-gray-600 hover:text-[#61CE70] transition-colors duration-200 font-bold">About</a></li>
            <li><a href="/premium" className="text-gray-600 hover:text-[#61CE70] transition-colors duration-200 font-bold">Plans</a></li>
            <li><a href="/contact" className="text-gray-600 hover:text-[#61CE70] transition-colors duration-200 font-bold">Contact</a></li>
          </ul>
          {/* Social Media Icons */}
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="text-gray-600 hover:text-[#61CE70] transition-colors duration-200 font-bold">Privacy Policy</a></li>
            <li><a href="#" className="text-gray-600 hover:text-[#61CE70] transition-colors duration-200 font-bold">Terms and Conditions</a></li>
            <li><a href="#" className="text-gray-600 hover:text-[#61CE70] transition-colors duration-200 font-bold">Refund Policy</a></li>
            <li><a href="#" className="text-gray-600 hover:text-[#61CE70] transition-colors duration-200 font-bold">E-Shipping & Delivery Policy</a></li>
          </ul>
        </div>
      </div>
    </footer>
