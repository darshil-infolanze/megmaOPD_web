            ...
            <section className="w-full max-w-md bg-white border border-violet-200 rounded-2xl shadow-xl px-8 py-10">
                ...
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center gap-3 mb-2">
                        <img src={logo} alt="Magma OPD" className="w-14 h-14 rounded-full " />
                        <Typography variant="h3" className="font-extrabold text-violet-600 tracking-tight">
                            Magma <span className="text-slate-800">OPD</span>
                        </Typography>
                    </div>
                    <Typography variant="paragraph" className="text-gray-600 text-base mt-2">
                        Admin Login
                    </Typography>
                </div>
